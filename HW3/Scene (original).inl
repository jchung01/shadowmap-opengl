...
void Scene::init(void){
    ...
    node["ground"]->models.push_back(model["table piece"]);
    node["ground"]->modeltransforms.push_back(translate(vec3(0.0f, -0.1f, 0.0f)) * scale(vec3(8.0f, 0.2f, 4.0f)));
    ...
    node["table"] -> childnodes.push_back( node["table leg"] );
    node["table"] -> childtransforms.push_back( translate(vec3(0.9f,0.0f,-0.4f)) );
    node["table"]->childnodes.push_back(node["ground"]);
    node["table"]->childtransforms.push_back(mat4(1.0f));
