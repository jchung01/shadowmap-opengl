...
struct SurfaceShader : Shader {
    ...
    // add light-space view, proj
    glm::mat4 view_light = glm::mat4(1.0f); GLuint view_light_loc;
    glm::mat4 projection_light = glm::mat4(1.0f); GLuint projection_light_loc;
    ...
    // temp, REMOVE
    GLfloat near = 0.01f; GLuint near_loc;
    GLfloat far = 100.0f; GLuint far_loc;
    ...
    void initUniforms(){
        ...
        view_light_loc = glGetUniformLocation(program, "view_light");
        projection_light_loc = glGetUniformLocation(program, "projection_light");
    ...
    void setUniforms(){
        ...
        glUniformMatrix4fv(view_light_loc, 1, GL_FALSE, &view_light[0][0]);
        glUniformMatrix4fv(projection_light_loc, 1, GL_FALSE, &projection_light[0][0]);
